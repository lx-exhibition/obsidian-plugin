...
let el = props.el as HTMLElement
let val = ref()
watchEffect(()=>{
	el.findAll('')
})
...
<template>
	<div class="floating-search-box" id="searchBox">
		<div style="display: flex;flex-direction: row">
			<input type="text" class="search-input" placeholder="Search..." v-model="val">
...
.floating-search-box:active{opacity: 0.7}
.search-input{}
...
.match{background-color: #007000}
.focus{background-color: #008000}
</style>
